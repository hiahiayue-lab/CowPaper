...
const enterNoOp = reduceLibrarySearchKeyboard(state, { key: "Enter" });
assert(enterNoOp === state, "Enter is inert in the Search Box");
assert(enterNoOp.query.libraryTagIds.length === 0, "Enter never applies a suggestion");
